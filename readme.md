# Crash Avoidance with MA-SST-DDPG
...
<p align="center">
  <img src="docs/framework.png" alt="Framework Overview" width="600">
</p>
...
Dataset access: [High-Density Intersection Dataset](https://github.com/Qpu523/High-density-Intersection-Dataset)
...
<p align="center">
  <img src="docs/results.png" alt="Trajectory Reconstruction" width="600">
</p>

### Model Comparison

| Model                  | ADE (m) | FDE (m) | CT (ms/step) |
|-------------------------|---------|---------|--------------|
| **MA-SST-DDPG**        | **0.078** | **0.156** | 16 |
| MA-State-Space-DDPG    | 0.083   | 0.165   | 15 |
| MA-Transformer-DDPG    | 0.098   | 0.196   | 18 |
| MA-LSTM-DDPG           | 0.123   | 0.247   | 22 |
| MA-DDPG                | 0.164   | 0.328   | 14 |
| DDPG                   | 0.679   | 1.357   | 7 |
| DenseTNT               | 0.420   | 0.850   | 12 |
| MultiPath++            | 0.450   | 0.920   | 14 |
